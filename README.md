...
The two doors that booted the reconstructed Grok Bot desktop app were deleted on 20 Sep 2026
(`docs/LEGAL.md`).
...
desktop client and seam B were built in slices 7 to 9 and deleted on 20 Sep 2026. **[`docs/ROADMAP.md`](docs/ROADMAP.md) is the tracker** — a box is
