...
| [`seam-a-client-facts.md`](seam-a-client-facts.md) | CLAUDE.md's former "Three facts" #1 and #3, about the Grok Bot client and seam A, word for word | the client and its doors were removed 20 Sep 2026; NativeChat is [`../setup/nativechat.md`](../setup/nativechat.md) |
