...
| [`sandbox-box-ascii-dev.md`](sandbox-box-ascii-dev.md) | box.ascii.dev: verdict, full endpoint table, pinned shapes (`box.id`, `X-Ascii-Confirm-Delete`), the typed `ascii::Client`, and the gaps (no streaming exec, no dir listing, VNC-only computer-use, hosted-only) | touching `opengrok-box` ascii |
| [`sandbox-grok-box.md`](sandbox-grok-box.md) | grok-box (`hexuria/box`): guest HTTP wire, BOX_TOKEN, lifecycle vs EnsureBox, what must never reach the browser | touching `opengrok-box` grok_box or `/console` computers |
| [`../box/README.md`](../box/README.md) | Local copy of the Box Public API v1 pages + OpenAPI spec (vendor markdown, not ours) | fixing or extending `opengrok-box` against the live ascii contract |
