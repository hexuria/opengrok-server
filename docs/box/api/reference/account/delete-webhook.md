...
> Delete a Box lifecycle webhook endpoint and its queued deliveries.



## OpenAPI

````yaml openapi/box-v1.yaml DELETE /webhooks/{webhookId}
openapi: 3.1.0
info:
...
paths:
  /webhooks/{webhookId}:
    ...
    delete:
      ...
      description: >-
        Deletes the endpoint and its queued deliveries. An attempt already in
        flight can still arrive.
