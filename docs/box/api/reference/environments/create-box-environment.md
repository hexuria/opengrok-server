...
````yaml openapi/box-v1.yaml POST /environments
openapi: 3.1.0
info:
...
paths:
  /environments:
    post:
      tags:
        - Box
      summary: Create a Box environment
      description: >-
        Create a new named environment. It starts on version 1 with all
        fine-grained flags on and `safeForThirdParties` off.
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: '#/components/schemas/CreateBoxEnvironmentRequest'
      responses:
        '200':
    ...
    CreateBoxEnvironmentRequest:
      ...
      properties:
        name:
          ...
          pattern: ^[a-zA-Z0-9._-]+$
          description: >-
            Unique environment name. Letters, numbers, dot, dash, underscore;
            max 64 chars.
          examples:
            - customer-demos
