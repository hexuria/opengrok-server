...
````yaml openapi/box-v1.yaml PUT /environments/{environmentId}/vars/{key}
openapi: 3.1.0
info:
...
paths:
  /environments/{environmentId}/vars/{key}:
    ...
    put:
      ...
      description: >-
        Sets or replaces a single variable without reading or rewriting the
        rest. Mints a new immutable version.
