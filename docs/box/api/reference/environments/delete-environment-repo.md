...
````yaml openapi/box-v1.yaml DELETE /environments/{environmentId}/repos/{repositoryId}
openapi: 3.1.0
info:
...
paths:
  /environments/{environmentId}/repos/{repositoryId}:
    delete:
      ...
      description: >-
        Removes one repository from the environment's selection. Mints a new
        immutable version.
