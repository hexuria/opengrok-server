...
doors that booted the reconstructed desktop app were deleted on 20 Sep 2026; `docs/LEGAL.md` says
...
| What | Where |
|---|---|
| The desktop client we used to serve | `/Volumes/goldcoders/OSS/opengrok` — reference: `docs/research/client-grok-bot.md` (history since 20 Sep 2026) |
